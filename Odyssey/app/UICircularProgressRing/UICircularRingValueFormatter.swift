...
public struct UICircularProgressRingFormatter: UICircularRingValueFormatter {
    ...
    /**
     A toggle for showing or hiding the integer of
     progress in the value label
     ...
     Hayden Seay
     */
    public var showValueInteger: Bool
